...
test.describe('Chart Real Flow Test', () => {
  test('should reproduce the exact error when running pipeline and clicking chart', async ({ page }) => {
    ...
    await page.fill('input[placeholder*="name" i], input[placeholder*="Name" i]', 'Test Connection');
    await page.fill('input[placeholder*="uri" i], input[placeholder*="URI" i], input[placeholder*="connection" i]', 'mongodb://localhost:27017/pipe-lens');
